...
public class AccomodationEntityFixture {
	...
	public static List<AccomodationImage> getAccomodationImageUrl() {
		...
		return Arrays.asList(
				AccomodationImage.builder().id(1L).imgUrl("image url 1").accomodation(accomodation).build(),
				AccomodationImage.builder().id(2L).imgUrl("image url 2").accomodation(accomodation).build());
	}
