...
public class CartServiceTest {
  ...
  public void testConfirmCartItemsWithInvalidDatesShouldThrowException() {
    ...
    request.setRoomId(room.getId());
    request.setCheckIn(reservation.getCheckIn());
    request.setCheckOut(LocalDateTime.of(2023, 6, 19, 11, 0));
  ...
  public void testConfirmCartItemsWithReservationMismatchShouldThrowException() {
    ...
    request.setCheckIn(reservation.getCheckIn());
    request.setCheckOut(reservation.getCheckOut());
  ...
  public void testConfirmCartItemsWithValidRequestShouldConfirmReservation()
    ...
    // Then
    verify(reservationRepository).updateReservationStatus(request.getReservationId(),
