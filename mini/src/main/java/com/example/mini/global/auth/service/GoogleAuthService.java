...
public class GoogleAuthService {
    ...
    public TokenResponse getGoogleToken(String code) {
        ...
        if (response.getStatusCode() == HttpStatus.OK) {
            ...
            CookieUtil.addCookie(httpResponse, "googleAccessToken", googleAccessToken, googleAccessTokenExpiresIn, true);
            ...
            if (body.getRefresh_token() != null) {
                ...
                CookieUtil.addCookie(httpResponse, "googleRefreshToken", googleRefreshToken, 30 * 24 * 60 * 60, true);
    ...
    public TokenResponse getGoogleRefreshedToken(String refreshToken) {
        ...
        if (response.getStatusCode() == HttpStatus.OK) {
            ...
            if (body.getRefresh_token() != null) {
                ...
                CookieUtil.addCookie(httpResponse, "googleRefreshToken", newRefreshToken, 30 * 24 * 60 * 60, true);
