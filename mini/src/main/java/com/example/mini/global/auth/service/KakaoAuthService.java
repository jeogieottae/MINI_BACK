...
public class KakaoAuthService {
    ...
    public TokenResponse getKakaoToken(String code) {
        ...
        if (response.getStatusCode() == HttpStatus.OK) {
            ...
            CookieUtil.addCookie(HttpResponse, "kakaoAccessToken", kakaoAccessToken, kakaoAccessTokenExpiresIn, true);
            CookieUtil.addCookie(HttpResponse, "kakaoRefreshToken", kakaoRefreshToken, refreshTokenExpiresIn, true);
